...
<div class="work-grid">
  ...
  <div class="work-block">
    ...
    {% include section-preview.html tag="coding" limit="3" %}
    <a href="{{ site.baseurl }}/tags/coding" class="button">More →</a>
  </div>
  ...
  <div class="work-block">
    ...
    {% include section-preview.html tag="teaching" limit="3" %}
    <a href="{{ site.baseurl }}/tags/teaching" class="button">More →</a>
  </div>
